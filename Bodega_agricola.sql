create database bodega_agricola;
use bodega_agricola;
...
create table if not exists tbl_empleado(
    ...
    genero_empleado					int(2),
    estado_empleado					int(2)
);
...
create table if not exists tbl_proveedor(
    ...
    apellido_proveedors					varchar(20),
    dpi_proveedors						int(15),
    direccion_proveedors				varchar(50),
    nit_proveedors						int(15),
    fechanacimiento_proveedors			date,
    fechaingreso_proveedors				date,
    telefono_proveedors					int(9),
    correo_proveedors					varchar(50),
    estado_proveedors					int(2)
);
...
create table if not exists tbl_vendedor(
    ...
    genero_vendedor						int(2),
    estado_vendedor						int(2)
);
